...
#test only 1 server
board_frontpage_footer_template = open('board_frontpage_footer_template.html').read()
board_frontpage_header_template = open('board_frontpage_header_template.html').read()
boardcontents_template = open('boardcontents_template.html').read()
entry_template = open('entry_template.html').read()
